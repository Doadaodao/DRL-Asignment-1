...
with open("q_table_custom_env_station_feature_30000.pkl", "wb") as f:
    pickle.dump(q_table, f)

print("Training finished and Q-table saved to q_table_custom_env_station_feature_30000.pkl.")
